...
After creating an agent, selecting an investment profile, and depositing supported assets, your agent begins managing your portfolio autonomously. If you want greater control, you can also customise its behaviour simply by talking to it.
...
Each agent is completely independent. You can create multiple agents, each with different assets, investment profile, or personalised preferences.

---

## Step 3 — Choose an Investment Profile

Every new agent begins with a default investment profile that determines how it approaches portfolio management.
...
Rather than chasing the highest advertised APY, Autoseek seeks the highest long-term **risk-adjusted** return while respecting your selected investment profile and any preferences you have configured.
...
Your agent works immediately using its default investment profile, but you can refine its behaviour at any time.
