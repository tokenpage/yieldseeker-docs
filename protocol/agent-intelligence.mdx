...
Every Agent is capable of managing a portfolio autonomously from the moment it is created. Users who simply want automated portfolio management can choose an investment style, deposit their assets, and allow the Agent to manage the portfolio independently.
...
Every Agent begins with sensible default behaviour based on the selected investment style:
...
For many users, selecting an investment style is all that's required. The Agent will continue managing the portfolio autonomously without any further interaction.
...
The Allocation Engine then evaluates available opportunities while respecting those preferences alongside the Agent's selected investment style.
