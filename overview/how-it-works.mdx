...
First, connect your self-custodied wallet to the platform. Yield Seeker currently operates on the Base network and supports standard wallet integrations.

Next, create your personalized AI agent, give it a name and a symbol, in the background your own agent wallet will be created.

Once your agent is configured, you can deposit USDC into the system. Your funds are transferred into smart contracts controlled by the Yield Seeker platform—not your personal wallet—allowing the AI agent to manage your capital efficiently and securely.

From that point on, your agent operates autonomously. It continuously scans the ecosystem for the most promising yield opportunities and reallocates funds as needed to capture optimal performance.
