...
Yes, you can withdraw your funds at any time through the Wallet page. Withdrawals are processed in the same token you deposited, currently we only support USDC. Your agent will become idle upon withdrawal of all tokens.
